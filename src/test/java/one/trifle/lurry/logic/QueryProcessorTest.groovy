...
class QueryProcessorTest extends Specification {
    ...
    "template(#template, #params, #driverName) == #result"() {
        ...
        'a in (${a.join()})'                            | [a: ['1', "\\'2\\'", '3'] as String[]] | ""                      || "a in ('1','\\''2\\''','3')"

        "a = \${a.escape()} AND b = '\$b'"              | [a: "'a\\'"]                           | "com.mysql.jdbc.Driver" || "a = '''a\\\\''' AND b = 'null'"
        'a in (${a.join()})'                            | [a: [1, 2, 3] as Number[]]             | "com.mysql.jdbc.Driver" || "a in (1,2,3)"
        'a in (${a.join()})'                            | [a: ['1', "\\'2\\'", '3'] as String[]] | "com.mysql.jdbc.Driver" || "a in ('1','\\\\''2\\\\''','3')"
